...
import { PATIENT_NAV } from './patientNav'
  ...
  return (
    <div className="admin-shell">
      ...
      <aside className={`admin-sidebar ${sidebarOpen ? 'admin-sidebar--open' : ''}`}>
        ...
        <nav className="admin-sidebar__nav" aria-label="Patient navigation">
        ...
        <div className="admin-sidebar__footer">
          <p className="admin-sidebar__user">{user?.username || 'Patient'}</p>
      ...
      <div className="admin-shell__main">
        <header className="admin-topbar">
          ...
          <p className="admin-topbar__title">Patient Portal</p>
        </header>
